    ...
    render() {
        return (
           ...
           <Text style={{marginLeft:120, margin:4}}>sublime</Text>
            ...
            <View style={{marginTop:90,marginLeft:70,backgroundColor:'#6C3483', width:200, borderRadius:60,}}>
              <Button onPress={() =>this.props.navigation.navigate('SignUp')}>
                <Text style={{color:'white', fontSize:10, alignItems:'center'}}>Get started</Text>
              </Button>
